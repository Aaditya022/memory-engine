  ...
  return (
    ...
    >
      <motion.div
        ...
        className="mx-auto max-w-6xl rounded-2xl border border-border/10 bg-card/30 backdrop-blur-sm shadow-2xl shadow-black/20 overflow-hidden transition-shadow duration-300 hover:shadow-[0_0_60px_rgba(59,130,246,0.08)]"
        style={{ rotateX, rotateY, transformStyle: 'preserve-3d' }}
        transition={{ type: 'spring', stiffness: 80, damping: 25 }}
      >
        {/* Browser chrome bar */}
        <div className="flex items-center gap-2 px-5 h-11 border-b border-border/10 bg-background/50">

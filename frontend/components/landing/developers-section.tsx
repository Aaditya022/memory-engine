...
const codeExamples = [
  {
    label: "Install",
    code: `npm install @memoryengine/sdk

# or
yarn add @memoryengine/sdk
pnpm add @memoryengine/sdk`,
  },
  {
    label: "Initialize",
    code: `import { MemoryEngine } from '@memoryengine/sdk'

const memory = new MemoryEngine({
  apiKey: process.env.MEMORY_ENGINE_KEY
})`,
  },
  {
    label: "Ask",
    code: `const answer = await memory.ask({
  query: 'How do I reset a customer plan?',
  user: currentUser.id,
  cite: true
})
...
const features = [
  ...
  { 
    ...
    description: "Every answer ships with structured source metadata."
  },
  { 
    title: "12KB gzipped", 
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground mb-12 leading-relaxed">
              Bring trusted answers into any product or workflow. A clean retrieval API,
              permission-aware queries, and exceptional documentation.
            </p>

...
const securityFeatures = [
  ...
  },
  {
    ...
    description: "Answers respect source-level access. Users only see knowledge they're already entitled to.",
  },
  {
    icon: FileCheck,
    title: "GDPR & HIPAA",
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground leading-relaxed mb-12">
              Your knowledge is your most sensitive asset. Memory Engine keeps it private,
              encrypted, and permission-aware at every layer—your data is never used to train shared models.
            </p>

        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground leading-relaxed mb-12">
              Your knowledge lives on a globally distributed vector index across 17 regions,
              returning cited answers in under 300ms no matter where your team works.
            </p>
            ...
            <div className="grid grid-cols-3 gap-8">
              ...
              <div>
                <div className="text-4xl lg:text-5xl font-display mb-2">&lt;300ms</div>

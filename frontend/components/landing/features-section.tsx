...
const features = [
  {
    ...
    description: "Ask a question in plain language and get the exact answer in seconds—pulled and cited from across every connected source.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "AI Answers You Can Trust",
    description: "Every response is grounded in your own knowledge with inline citations, so teams get accurate answers without the hallucinations.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Always in Sync",
    description: "Memory Engine continuously indexes your docs, tickets, and chats in real time. Your knowledge stays fresh—no manual updates required.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Permission-Aware by Design",
    description: "Answers respect your existing access controls. People only ever see knowledge they're already allowed to access.",
    visual: "security",
  },
];
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 lg:mb-24">
          ...
          >
            ...
            <br />
            <span className="text-muted-foreground">Finally in one place.</span>
          </h2>
        </div>
